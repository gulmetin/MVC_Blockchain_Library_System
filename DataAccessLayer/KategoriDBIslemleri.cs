...
namespace DataAccessLayer
{
    public class KategoriDBIslemleri
    {
        ...
        public List<Kategori> getAllKategori()//tblKategori tablosundaki bütün verileri çekiyor
        {
            return db.Database.SqlQuery<Kategori>("select * from getAllKategori").ToList();
        }
